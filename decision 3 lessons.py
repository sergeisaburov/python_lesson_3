...
# но он остается в переменной rasskaz_without
handle.close()
low_reg = rasskaz_without.lower()  # в переменной rasskaz_without есть слова с заглавными буквами, эти слова делаем все со строными буквами
